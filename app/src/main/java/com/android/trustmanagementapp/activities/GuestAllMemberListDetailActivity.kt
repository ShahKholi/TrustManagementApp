...
import com.android.trustmanagementapp.adapter.GuestAllMemberListAdapter
...
class GuestAllMemberListDetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_guest_all_member_list_detail)
    ...
    fun successMemberListFromFirestore(memberList: ArrayList<MemberClass>){
        ...
        if(mMemberList.size>0){
            ...
            val viewMemberListAdapter = GuestAllMemberListAdapter(
